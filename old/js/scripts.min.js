...
$(function(){window.screen.width>992&&$(window).scroll(function(){var t=$(this).scrollTop();t>$(this).height()-250?$("#content-optim").css("margin-left","0"):$("#content-optim").css("margin-left","-1000px"),t>$(this).height()+100?$("#content-adapt").css("margin-right","0"):$("#content-adapt").css("margin-right","-1000px"),t>$(this).height()-350?$("#btn-up").css("margin-right","10px"):$("#btn-up").css("margin-right","-60px")}),$(window).scroll(function(){var t=$(this).scrollTop();t>$(this).height()-250?$(".anim-left").css("margin-left","0"):$(".anim-left").css("margin-left","-1000px"),t>$(this).height()+100?$(".anim-right").css("margin-right","0"):$(".anim-right").css("margin-right","-1000px"),t>$(this).height()?$(".header-text").fadeOut(10):$(".header-text").fadeIn(2500),t>$(this).height()+350?$(".call").css("opacity","1"):$(".call").css("opacity","0")}),$("#call-form").submit(function(){var t=$(this);return $.ajax({type:"POST",url:"mail.php",data:t.serialize()}).done(function(){$(".call-form").addClass("blur"),$(".call-success").css("display","flex"),setTimeout(function(){t.trigger("reset")},3e3)}),!1})});function showPopup(t){$("#hamburger").addClass("is-active"),$(t).fadeIn(1e3)}function hidePopup(t){$("#hamburger").removeClass("is-active"),$(t).fadeOut(1e3)}function slowScroll(t){return $("html, body").animate({scrollTop:$(t).offset().top},500),!1}$(window).on("load",function(){$(".preloader").fadeOut(2500),$(".header-text").fadeOut(10),setTimeout(function(){$(".header-text").fadeIn(3e3)},500)});